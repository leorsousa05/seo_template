<header class="header">
	<div class="header__container">
		<a class="header__container__logo" href="#">
			<img class="header__container__logo__image" src="https://www.hubspot.com/hs-fs/hubfs/Shell_logo.svg.png?width=450&height=417&name=Shell_logo.svg.png" width="80" height="80" alt="Logo example">
		</a>
		...
		<div class="header__container__burger_menu" id="burger_menu">
			<div class="header__container__burger_menu__item"></div>
			<div class="header__container__burger_menu__item"></div>
			<div class="header__container__burger_menu__item"></div>
		</div>
	</div>
