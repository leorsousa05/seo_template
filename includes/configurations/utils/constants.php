 ...
 *
 * @const string O caminho base do diretório do website.
 */
 ...
 * @const string O caminho base do diretório de estilização do website.
 * */
 ...
 * @var string O caminho base do diretório de scripts do website.
 * */
 ...
 *
 * @const array Lista de URLs de páginas não dinâmicas do website.
 */
